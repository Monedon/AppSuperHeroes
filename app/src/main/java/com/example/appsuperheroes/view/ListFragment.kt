...
import com.example.appsuperheroes.databinding.FragmentListBinding
import com.example.appsuperheroes.model.HeroAdapter
...
class ListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.heroReciclerView.layoutManager= LinearLayoutManager(context)
        binding.heroReciclerView.adapter=adapter
